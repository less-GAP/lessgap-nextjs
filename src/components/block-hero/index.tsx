	...
	return (
		<section className={`${styles.hero} py-25 px-5`}>
			<div className={`${styles.content} flex flex-col py-20 px-5 max-w-[500px] sm:max-w-[600px] lg:max-w-[800px] xl:max-w-[1000px] 2xl:max-w-[1200px] 8xl:max-w-[1400px]`}>
				...
				<div className="inline-flex w-fit mx-auto items-center justify-center mt-5 md:mt-10 py-3 border-t-2 border-b-2">
				...
				<div className="relative mt-15">
					<Link className="group font-extrabold inline-block w-fit items-center bg-white !border-0 py-3 px-10 md:py-4 md:px-15 text-black shadow-lg uppercase" href="#register">
						Register Now
					</Link>
				</div>
