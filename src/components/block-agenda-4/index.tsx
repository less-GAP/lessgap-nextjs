...
export default function BlockAgenda() {
	...
	return (
		...
		<section className={`${styles.index} bg-slate-100 text-black py-25 px-5`}>
			...
			<div className="container mx-auto max-w-[640px] mt-5">
				<div className="grid grid-cols-1 gap-3 md:gap-10">
					<div className="w-full overflow-hidden">
						<h4 className="text-xl md:text-2xl mt-10 font-extrabold uppercase">FRIDAY, JULY 29</h4>
						...
						<p className="mt-5">
							<button className="text-gray-900 underline" onClick={() => isModalOpen ? setIsModalOpen('') : setIsModalOpen('agenda')}>Details &rarr;</button>
						</p>
						<Modal title={false} wrapClassName="modal-fullscreen" open={isModalOpen === 'agenda'} onCancel={() => setIsModalOpen('')} footer={null} centered keyboard={false} width={600} maskClosable={false}>
							<div className="p-3">
								...
								<ol className="relative border-l border-gray-200">
									<li className="mb-10 ml-6">
										...
										<h3 className="flex flex-col md:flex-row md:items-center mb-1 text-lg font-normal text-gray-800">
											...
											<time className="block text-sm font-normal leading-none text-gray-400 dark:text-gray-500">01:15 PM to 02:00 PM</time>
										</h3>
										<ul className='mt-3 font-light list-disc pl-5 text-md text-gray-700'>
									...
									<li className="mb-10 ml-6">
										...
										<h3 className="flex flex-col md:flex-row md:items-center mb-1 text-lg font-normal text-gray-800">
											...
											<time className="block text-sm font-normal leading-none text-gray-400 dark:text-gray-500">02:00 PM to 02:40 PM</time>
										</h3>
										<ul className='mt-3 font-light list-disc pl-5 text-md text-gray-700'>
									...
									<li className="mb-10 ml-6">
										...
										<h3 className="flex flex-col md:flex-row md:items-center mb-1 text-lg font-normal text-gray-800">
											...
											<time className="block text-sm font-normal leading-none text-gray-400 dark:text-gray-500">03:00 PM to 04:00 PM</time>
										</h3>
									...
									<li className="mb-10 ml-6">
										...
										<h3 className="flex flex-col md:flex-row md:items-center mb-1 text-lg font-normal text-gray-800">
											...
											<time className="block text-sm font-normal leading-none text-gray-400 dark:text-gray-500">04:00 PM to 04:45 PM</time>
										</h3>
