...
export default function BlockHero() {
	...
	return (
		<section className={`${styles.hero} py-25 px-5 overflow-hidden`}>
			<div className={`${styles.herovideo}`}>
				<video className={`${styles.herovideoscreen}`} autoPlay loop muted playsInline src="/video/video.mp4"></video>
			</div>
			<div className={`${styles.content} flex flex-col py-20 px-5 max-w-[500px] sm:max-w-[600px] lg:max-w-[800px] xl:max-w-[1000px] 2xl:max-w-[1200px] 8xl:max-w-[1400px]`}>
				<div className="inline-flex w-fit mx-auto items-center justify-center mt-20 mb-5 md:mb-10 py-3 border-t-2 border-b-2">
