...
export default function BlockDesc() {
	...
	return (
		<>
			<div className={`${styles.heading} flex flex-col xl:flex-row mx-auto md:px-10 xl:px-25 2xl:space-x-25 px-5`}>
				<div className="container mx-auto max-w-[550px] md:max-w-[900px] xl:max-w-[1800px]">
					<div className="flex flex-col xl:flex-row mx-auto md:px-10 xl:px-25 xl:space-x-15 3xl:space-x-15">
						<h2 className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl 3xl:text-8xl 4xl:text-9xl 5xl:text-10xl 6xl:text-11xl font-extrabold leading-none">
							ADVANCED AUTOMATION
						</h2>
					</div>
				</div>
			</div>
			<div className={`${styles.break} -mt-5`}></div>
			<section className={`${styles.index} text-white bg-black flex flex-col xl:flex-row mx-auto md:px-10 xl:px-25 2xl:space-x-25 px-5 xl:py-15 2xl:py-[5vw] overflow-hidden`}>
				<div className="container mx-auto max-w-[550px] md:max-w-[900px] xl:max-w-[1800px]">
					<div className="flex flex-col 2xl:flex-row mx-auto md:px-10 xl:px-25 2xl:space-x-10 3xl:space-x-15">
						...
						<div className="flex flex-col basics 2xl:w-1/2 mb-5">
							<div className="2xl:bg-white 2xl:text-black 2xl:py-10 2xl:px-10">
								<h2 className="text-md md:text-lg lg:text-xl xl:text-2xl 3xl:text-3xl font-bold leading-tight mt-10 md:mt-15 2xl:mt-0">
									WHAT WILL YOU LEARN?
								</h2>
			...
			<div className="container mx-auto xl:max-w-[1400px] my-5">
