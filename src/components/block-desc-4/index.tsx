...
export default function BlockDesc() {
	...
	return (
		...
		<section className={`${styles.index} py-15 px-5 lg:py-25 xl:py-[10vw]`}>
			<Fade cascade>
				<div className="container mx-auto max-w-[550px] md:max-w-[900px] xl:max-w-[1800px] mt-5">
				...
				<div className="container mx-auto xl:max-w-[1400px] mt-5">
					<div className="mt-10 flex flex-col md:flex-row mx-auto space-y-5 md:space-y-0 lg:px-25 md:space-x-15 3xl:space-x-15 items-center">
